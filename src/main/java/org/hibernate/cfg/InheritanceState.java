...
public class InheritanceState {
    ...
    public XClass getClassWithIdClass(boolean evenIfSubclass) {
        ...
        if (clazz.isAnnotationPresent(IdClass.class)) {
            ...
            org.hibernate.cfg.InheritanceState state = org.hibernate.cfg.InheritanceState.getSuperclassInheritanceState(clazz, inheritanceStatePerClass);
            if (state != null) {
    ...
    private void addMappedSuperClassInMetadata(PersistentClass persistentClass) {
        ...
        final org.hibernate.cfg.InheritanceState superEntityState =
                org.hibernate.cfg.InheritanceState.getInheritanceStateOfSuperEntity(clazz, inheritanceStatePerClass);
